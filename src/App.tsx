...
import type { Player, MatchResult, Theme, MatchAlgorithm, ManualAssignment, PlayerPosition } from './types';
...
export default function App() {
  ...
  function handleSlotDrop(slotKey: string, playerId: string) {
    setManualAssignment(prev => {
      ...
      // Only evict the player from other slots within the same round.
